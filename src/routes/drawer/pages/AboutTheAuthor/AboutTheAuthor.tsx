import React, { Box, Grid2, Stack, Typography } from '@mui/material';
      ...
      <Stack>
        <Box textAlign="center" border="solid">
          ...
          <Typography textAlign="left" marginLeft="1rem">
            I enjoy coding and creating software to help my everyday life. My other hobbies include figuring out how devices
            work, sometimes taking them apart. Outside of coding, I enjoy video games and exploring the world.
          </Typography>
          <PartitionDivider />
          ...
          <Typography border="dashed 0.125rem white">
            ...
            <Grid2 container direction="row" size={{ xs: 12 }}>
              ...
              <Grid2 container size={{ xs: 5 }}>
                <SkillList title="Achievements" skills={['Developed iterations of PCB', 'Developed 3D printed housing']} />
              </Grid2>
            </Grid2>
          </Typography>
